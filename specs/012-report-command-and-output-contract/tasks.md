...
- [X] T007 Add failing CLI tests for `tenantguard report`.

## Phase 3: Report Package

- [X] T008 Add `@tenantguard/report` package with types, schema, loader, renderer, and writer.
...
- [X] T011 Add `tenantguard report` command and exports.
